...
public class PetStoreService {
	...
	public PetStoreCustomer saveCustomer(Long petStoreId, PetStoreCustomer petStoreCustomer) {
	    ...
	    if (petStoreCustomers == null) {
	        petStoreCustomers = new HashSet<>();
	...
	private Customer findCustomerById(Long petStoreId, Long customerId) {
		...
		throw new IllegalArgumentException(
				"Customer with ID=" + customerId + " does not exist in Pet Store with ID=" + petStoreId);
	}
	...
	public PetStoreData retrievePetStoreById(Long petStoreId) {
		PetStore petStoreData = findPetStoreById(petStoreId);
		return new PetStoreData(petStoreData);
	}
